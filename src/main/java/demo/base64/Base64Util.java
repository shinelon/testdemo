...
public class Base64Util {
    ...
    public static void main(String[] args) {
        ...
        // "TS=lKO<bYCHyHOLsH?@tI_DlHoLoJNUlKO@bUBa`KQ@mO`lmH_<sI_TsINU^VRLyJ?TmHoHpH_TqI\$$";
        // System.out.println(StringCompressUtil.compress(msg).toString());
        byte[] data = Base64Util.encodeBase64(msg);
        ...
        // byte[] data = "浣犲ソ鍝�".getBytes();
        // System.out.println(new String(headAndTailEncodeBase64(data)));
        // System.out.println(new
        // String(headAndTailDecodeBase64(headAndTailEncodeBase64("浣犲ソ鍝�".getBytes()))));
    }
}
