...
public class AtomicIntegerArrayTest {
	 ...
	 *      ִ�мӷ�����һ������Ϊ������±꣬�ڶ�������Ϊ���ӵ��������������Ӻ�Ľ��
	 * @see AtomicIntegerArray#compareAndSet(int, int, int)
	 *      �Ա��޸ģ�����1�������±꣬����2��ԭʼֵ������3���޸�Ŀ��ֵ���޸ĳɹ�����true����false
	 ...
	 *      ��decrementAndGet���ƣ������Ƿ��ر仯ǰ������
	 * @see AtomicIntegerArray#getAndIncrement(int)
	 *      ��incrementAndGet���ƣ������Ƿ��ر仯ǰ������
	 * @see AtomicIntegerArray#getAndSet(int, int)
	 *      ����Ӧ�±����������Ϊָ��ֵ���ڶ�������Ϊ���õ�ֵ�������Ǳ仯ǰ������
	 */
	private final static AtomicIntegerArray ATOMIC_INTEGER_ARRAY = new AtomicIntegerArray(
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < 100; i++) {
			...
			threads[i] = new Thread() {
				public void run() {
					int result = ATOMIC_INTEGER_ARRAY.addAndGet(index,
							index + 1);
					System.out.println("�̱߳��Ϊ��" + threadNum + " , ��Ӧ��ԭʼֵΪ��"
							+ (index + 1) + "�����Ӻ�Ľ��Ϊ��" + result);
				}
			};
			threads[i].start();
		}
